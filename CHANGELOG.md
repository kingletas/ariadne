...
- **The line down from the bookmark can be turned off**, from the same menu. It is what shows that every strip below the axis is on the same scale, and it crosses everything on the way down — so it is a hairline now rather than a rule, and a reader who finds it in the way can be rid of it.
